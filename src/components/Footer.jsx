...
export default function Footer({ setView, facebookLink, instagramLink }) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12 border-b border-gray-800">
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="flex space-x-4 pt-2">
            <a 
              href={instagramLink || "#"} 
              target={instagramLink && instagramLink !== '#' ? "_blank" : undefined} 
              rel={instagramLink && instagramLink !== '#' ? "noopener noreferrer" : undefined} 
              className="w-8 h-8 rounded-full border border-gray-800 hover:border-luxury-gold flex items-center justify-center text-gray-400 hover:text-luxury-gold transition-all duration-300" 
              title="Instagram"
            >
            ...
            <a 
              href={facebookLink || "#"} 
              target={facebookLink && facebookLink !== '#' ? "_blank" : undefined} 
              rel={facebookLink && facebookLink !== '#' ? "noopener noreferrer" : undefined} 
              className="w-8 h-8 rounded-full border border-gray-800 hover:border-luxury-gold flex items-center justify-center text-gray-400 hover:text-luxury-gold transition-all duration-300" 
              title="Facebook"
            >
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
